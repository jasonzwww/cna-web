...
import { ChevronLeft, Zap, BarChart3, ChevronRight, MapPin, Calendar, Clock } from 'lucide-react';
...
const SeriesGT3: React.FC = () => {
  const seriesName = RaceSeries.GT3_OPEN;
  ...
  return (
    <div className="min-h-screen bg-[#05070a] text-white">
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
         {/* Background Image */}
         <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1596728033065-20708f870933?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center"></div>
         ...
         <div className="relative z-10 w-full max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12 grid lg:grid-cols-2 gap-12 items-center pt-20">
            ...
            <div>
                ...
                <div className="flex flex-wrap items-center gap-3 mb-6 animate-in fade-in slide-in-from-left-4 duration-700">
                   <span className="bg-[#eb1923] text-white px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] rounded">Flagship</span>
                   <span className="border border-white/20 backdrop-blur-sm px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] rounded">Season 26</span>
                </div>
                ...
                <h1 className="text-7xl md:text-9xl font-oswald font-bold uppercase italic tracking-tighter leading-[0.9] mb-6 animate-in fade-in zoom-in-50 duration-700 delay-100">
                   GT3 <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#eb1923] to-orange-600">OPEN</span>
                </h1>
                ...
                <p className="text-xl text-gray-300 max-w-xl font-light leading-relaxed mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
                   The pinnacle of CNA competition. Featuring 60-minute endurance sprints, mandatory pit stops, custom BoP, and live stewarding.
                </p>
            ...
            <div className="flex justify-center lg:justify-end animate-in fade-in slide-in-from-right-8 duration-1000">
               {nextRace ? (
                 <div className="bg-[#0a0d14]/60 backdrop-blur-2xl border border-white/10 p-8 md:p-10 rounded-[2.5rem] shadow-2xl max-w-md w-full relative group overflow-hidden">
                    <div className="absolute top-0 right-0 p-12 bg-[#eb1923] blur-[80px] opacity-20 group-hover:opacity-30 transition-opacity"></div>
                    
                    <div className="relative z-10">
                      <div className="flex items-center justify-between mb-8">
                         <span className="text-xs font-black uppercase tracking-[0.2em] text-[#eb1923] flex items-center gap-2">
                           <span className="w-2 h-2 rounded-full bg-[#eb1923] animate-pulse"></span> Next Event
                         </span>
                      ...
                      <p className="text-gray-400 text-sm font-medium mb-8 flex items-center gap-2">
                        <MapPin size={14} className="text-[#eb1923]" /> Round {nextRace.round}
                      </p>
                      ...
                      <div className="flex justify-between gap-2 mb-8 border-t border-b border-white/5 py-8">
                         {timeLeft ? (
                           ...
                           <div className="w-full text-center py-4">
                             <span className="text-2xl font-oswald font-bold uppercase italic text-[#eb1923] animate-pulse">Race in Progress</span>
                           </div>
                         )}
                      </div>
      ...
      <div id="stats" className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-3 gap-16">
         ...
         <div className="lg:col-span-2">
            <div className="flex items-center gap-4 mb-10">
               <div className="p-3 bg-[#eb1923]/10 rounded-xl">
                  <BarChart3 className="text-[#eb1923]" size={24} />
               </div>
               <div>
                  <h2 className="text-3xl font-oswald font-bold uppercase italic tracking-tighter leading-none">Championship Battle</h2>
                  <p className="text-xs text-gray-500 font-bold uppercase tracking-widest">Top 3 Drivers</p>
               </div>
            </div>
            
            <div className="space-y-4">
               {standings.map((driver, idx) => (
                  <div key={idx} className="bg-[#0a0d14] border border-white/5 rounded-3xl p-6 flex items-center gap-8 hover:border-[#eb1923]/30 transition-all group">
                     <div className={`w-16 h-16 flex items-center justify-center font-oswald font-bold text-3xl italic rounded-2xl ${
                        idx === 0 ? 'bg-[#eb1923] text-white shadow-[0_0_30px_rgba(235,25,35,0.3)]' : 'bg-neutral-800 text-gray-500'
                     }`}>
                        {driver.pos}
                     </div>
                     <div className="flex-1">
                        <h3 className="text-2xl font-bold uppercase italic font-oswald text-white group-hover:text-[#eb1923] transition-colors">{driver.name}</h3>
                        <p className="text-xs text-gray-500 font-black uppercase tracking-widest">{driver.car}</p>
                     </div>
            ...
            <div className="mt-10 text-center md:text-left">
               <Link to="/results?series=GT3%20Open%20Series" className="inline-flex items-center gap-2 text-gray-500 hover:text-white text-xs font-black uppercase tracking-widest transition-colors">
         ...
         <div>
            <div className="bg-[#0a0d14] border border-white/5 rounded-[2.5rem] p-10 sticky top-24">
               <h3 className="text-2xl font-oswald font-bold uppercase italic tracking-tighter mb-8 flex items-center gap-3">
                  <Zap size={24} className="text-[#eb1923]" /> Race Protocol
               </h3>
               ...
               <div className="space-y-8 relative">
                  ...
                  <div className="relative pl-8">
                     <div className="absolute left-0 top-1.5 w-4 h-4 rounded-full bg-[#0a0d14] border-2 border-[#eb1923] z-10"></div>
                     ...
                     <div className="flex justify-between items-baseline">
                        ...
                        <span className="font-oswald font-bold text-xl italic text-gray-300">60m</span>
                     </div>
                  </div>
                  ...
                  <div className="relative pl-8">
                     ...
                     <div className="flex justify-between items-baseline">
                        <span className="text-white font-bold text-sm">Open Quali</span>
                        <span className="font-oswald font-bold text-xl italic text-gray-300">20m</span>
                     </div>
                  </div>

                  <div className="relative pl-8">
                     <div className="absolute left-0 top-1.5 w-4 h-4 rounded-full bg-[#eb1923] shadow-[0_0_15px_rgba(235,25,35,0.5)] z-10"></div>
                     <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest block mb-1">Race Session</span>
                     <div className="flex justify-between items-baseline">
                        <span className="text-white font-bold text-sm">Feature Race</span>
                        <span className="font-oswald font-bold text-xl italic text-white">40m</span>
                     </div>
                     <p className="mt-2 text-xs text-[#eb1923] font-bold uppercase tracking-wide border-t border-white/5 pt-2">
